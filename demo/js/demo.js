jQuery(document).ready(function ($) {
    ...
    if (getCookie('ct_daycare.switcher') == 'hide') {
        hideStyleswitcher();
    }
    ...
    jQuery('#demoReset').click(function () {
        setCookie('ct_daycare', false);
        location.reload(true);
        return false;
    });

    jQuery('#stylechooser .switch-animations input').click(function(){

        if($body.hasClass('withAnimation')){
            setCookie('ct_daycare.animations', 'false');
            location.reload(true);
        } else{
            setCookie('ct_daycare.animations', 'true');
            location.reload(true);
        }
    })
    ...
    function store() {
        ...
        setCookie('ct_daycare', r);
    }

    function load() {
        d = getCookie('ct_daycare');
        if (d) {
